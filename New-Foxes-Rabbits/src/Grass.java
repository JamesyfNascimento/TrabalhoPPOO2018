...
/**
 * A simple model of a grass. Grass age, breed, and die.
 */
public class Grass extends Plant {
  ...
  /**
   * Create a new grass. A grass may be created with age zero (a new born) or with
   * a random age.
   * 
  ...
  /**
   * This is what the grass does most of the time - it runs around. Sometimes it
  ...
  /**
   * Check whether or not this grass is to give birth at this step. New births
