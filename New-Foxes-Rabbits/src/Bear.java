...
public class Bear extends Animal {
  ...
  /**
   * Create a bear. A bear can be created as a new born (age zero and not hungry)
  ...
  /**
   * This is what the bear does most of the time: it hunts for foxes and rabbits.
  ...
  /**
   * Look for foxes and rabbits adjacent to the current location. Only the first
   * live foxes or rabbit is eaten.
   * 
